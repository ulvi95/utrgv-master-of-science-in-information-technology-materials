...
class BoxLayoutApp(App):
    ...
    def JSONrequest(self, *largs):
        ...
        if(self.led2.active==True):
            ...
            LED2=0
        data={'username':'ben', 'password':'benpass','SW1':SW1,'LED1':LED1,'SW2':SW2,'LED2':LED2}
        res=requests.post("https://csci3342a4.000webhostapp.com/scripts/sync_android_data.php",json=data)
        print(res)
        r=res.json()
        if(SW1!=r['SW1']):
